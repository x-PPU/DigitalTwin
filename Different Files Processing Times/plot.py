...
categories = ['Datasheets\n(PDF)', 'CAD models\n(STP/STEP)', 'PLC programs\n(PLCOpenXML)', 'SysML models\n(UML)', 'MATLAB/Simulink models\n (SLX)', 'Bills Of Materials\n(CSV)', 'Technical Reports\n(PDF)']
automatic = [7.47291176470588, 14.77388, 53.273, 798.092, 33.999, 1.725, 0]
manual_actual = [0, 0, 0, 0, 7200, 36000, 72000]
...
# footnote
fig.text(0.95, 0.01, 'manual: The amount of manual time required depends on the level of knowledge and familiarity with the xPPU plant', ha='right', va='bottom', fontsize=10)
