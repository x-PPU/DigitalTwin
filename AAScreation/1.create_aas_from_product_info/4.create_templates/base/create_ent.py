...
class ent:
    ...
    def create_SMC(self, id_short, value, category, semantic_id):
    ...
    def create_Prop(self, id_short, value_type, value, category, semantic_id):
        Prop = model.Property(
            id_short=id_short,
    ...
    def create_Range(self, id_short, value_type, min, max, category, semantic_id):
        Range = model.Range(
            id_short=id_short,
            value_type=value_type,
            min=min,
    ...
    def create_File(self, file_store, file_path, aasx_file_path, id_short, mime_type, category):
    ...
    def create_Rel(self, id_short, first_value, second_value, category):
        Rel = model.RelationshipElement(
            id_short=id_short,
            first=model.ModelReference(
                type_=model.KeyTypes.SUBMODEL_ELEMENT,
                key=[model.Key(type_=model.KeyTypes.SUBMODEL, value=first_value)]
            ),
            second=model.ModelReference(
                type_=model.KeyTypes.SUBMODEL_ELEMENT,
                key=[model.Key(type_=model.KeyTypes.SUBMODEL, value=second_value)]
            ),
            category=category,
        )
        return Rel

    def create_Ent(self, id_short, category, ent_type, statement, semantic_id):
        Ent = model.Entity(
            id_short=id_short,
            category=category,
