...
def create_nameplate_submodel(obj_store, file_store):
    ...
    address_elements = [
        ...
        ('Street', 'Im Tiefen See 45', '0173-1#02-AAO128#002'),
        ('Zipcode', '64293', '0173-1#02-AAO129#002'),
        ('CityTown', 'Darmstadt', '0173-1#02-AAO132#002'),
        ('StateCounty', 'Hessen', '0173-1#02-AAO133#002'),
        ('NationalCode', 'DE', '0173-1#02-AAO134#002'),
        ('AddressRemarks', 'Headquarters', '0173-1#02-AAO202#003'),
        ('AddressOfAdditionalLink', 'https://www.hbm.com/', '0173-1#02-AAQ326#002')
    ]

    phone_elements = [
        ('TelephoneNumber', '+49 6151 803-0', '0173-1#02-AAO136#002'),
        ('TypeOfTelephone', 'Office', '0173-1#02-AAO137#003')
    ]

    fax_elements = [
        ('FaxNumber', '+49 6151 803-9100', '0173-1#02-AAO195#002'),
        ('TypeOfFaxNumber', 'Office', '0173-1#02-AAO196#003')
    ]

    email_elements = [
        ('EmailAddress', 'info.de@hbkworld.com', '0173-1#02-AAO198#002'),
    ...
    # Create SMC Markings
    markings_elements = [
        ('MarkingName', 'HBM', get_iri_from_eclass('MarkingName')),
    ...
    temp_marking_file_path = Path(os.path.join(current_dir, 'logo', 'ManufacturerLogoHBM.jpg'))
    ...
    marking_file = ent_instance.create_File(
        ...
        aasx_file_path='/aasx/Logo/ManufacturerLogoHBM.jpg',
...
def create_general_information_submodel(obj_store, file_store):
    ...
    properties = [
        ('ManufacturerName', 'Hottinger, Brüel & Kjær GmbH', '0173-1#02-AAO677#002'),    
    ...
    # Use a temporary file path or replace with an existing file path
    temp_logo_file_path = Path(os.path.join(current_dir, 'logo', 'ManufacturerLogoHBM.jpg'))
...
if __name__ == '__main__':
    ...
    output_filename_aasx = output_dir / 'Template_hbm.aasx'
