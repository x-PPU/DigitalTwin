...
def create_nameplate_submodel(obj_store, file_store):
    ...
    properties = [
        ...
        ('CountryOfOrigin', 'Switzerland', '0173-1#02-AAO841#001'),
    ...
    address_elements = [
        ...
        ('Street', 'Portstrasse 38', '0173-1#02-AAO128#002'),
        ('Zipcode', '2503', '0173-1#02-AAO129#002'),
        ('CityTown', 'Biel', '0173-1#02-AAO132#002'),
        ('StateCounty', 'Bern', '0173-1#02-AAO133#002'),
        ('NationalCode', 'CH', '0173-1#02-AAO134#002'),
        ('AddressRemarks', 'Headquarters', '0173-1#02-AAO202#003'),
        ('AddressOfAdditionalLink', 'https://www.contelec.ch/', '0173-1#02-AAQ326#002')
    ]

    phone_elements = [
        ('TelephoneNumber', '+41 32 366 56 00', '0173-1#02-AAO136#002'),
    ...
    email_elements = [
        ('EmailAddress', 'sales@contelec.ch', '0173-1#02-AAO198#002'),
    ...
    # Create SMC Markings
    markings_elements = [
        ('MarkingName', 'Contelec', get_iri_from_eclass('MarkingName')),
    ...
    temp_marking_file_path = Path(os.path.join(current_dir, 'logo', 'ManufacturerLogoContelec.png'))
    ...
    marking_file = ent_instance.create_File(
        ...
        aasx_file_path='/aasx/Logo/ManufacturerLogoContelec.png',
...
def create_general_information_submodel(obj_store, file_store):
    ...
    properties = [
        ('ManufacturerName', 'Contelec AG', '0173-1#02-AAO677#002'),    
    ...
    # Use a temporary file path or replace with an existing file path
    temp_logo_file_path = Path(os.path.join(current_dir, 'logo', 'ManufacturerLogoContelec.png'))
...
if __name__ == '__main__':
    ...
    output_filename_aasx = output_dir / 'Template_contelec.aasx'
