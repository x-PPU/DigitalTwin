...
def create_nameplate_submodel(obj_store, file_store):
    ...
    address_elements = [
        ('Department', 'office', '0173-1#02-AAO127#003'),
        ('Street', 'Baarstr. 3', '0173-1#02-AAO128#002'),
        ('Zipcode', 'D-78652', '0173-1#02-AAO129#002'),
        ('CityTown', 'Deißlingen', '0173-1#02-AAO132#002'),
        ...
        ('AddressOfAdditionalLink', 'https://www.ott-antriebstechnik.de/', '0173-1#02-AAQ326#002')
    ]

    phone_elements = [
        ('TelephoneNumber', '+49 7420 9399-0', '0173-1#02-AAO136#002'),
    ...
    email_elements = [
        ('EmailAddress', 'info@ott-antriebstechnik.de', '0173-1#02-AAO198#002'),
    ...
    markings_elements = [
        ('MarkingName', 'OTT Antriebstechnik', get_iri_from_eclass('MarkingName')),
        ('MarkingAdditionalText', None, get_iri_from_eclass('MarkingAdditionalText'))
    ]

    temp_marking_file_path = Path(os.path.join(current_dir, 'logo', 'ManufacturerLogoOtt.jpg'))
    ...
    marking_file = ent_instance.create_File(
        ...
        aasx_file_path='/aasx/Logo/ManufacturerLogoOtt.jpg',
...
def create_general_information_submodel(obj_store, file_store):
    ...
    properties = [
        ('ManufacturerName', 'Ott GmbH & Co. KG', '0173-1#02-AAO677#002'),
    ...
    temp_logo_file_path = Path(os.path.join(current_dir, 'logo', 'ManufacturerLogoOtt.jpg'))
...
if __name__ == '__main__':
    ...
    output_filename_aasx = output_dir / 'Template_ott.aasx'
