...
def create_nameplate_submodel(obj_store, file_store):
    ...
    # Create SMC Address
    address_elements = [
        ('Department', 'Head Office', '0173-1#02-AAO127#003'),
        ('Street', 'Hans-Bernstein-Str. 1', '0173-1#02-AAO128#002'),
        ('Zipcode', '32457', '0173-1#02-AAO129#002'),
        ('CityTown', 'Porta Westfalica', '0173-1#02-AAO132#002'),
        ...
        ('AddressOfAdditionalLink', 'https://www.bernstein.eu/', '0173-1#02-AAQ326#002')
    ]

    phone_elements = [
        ('TelephoneNumber', '+49 5731 780-0', '0173-1#02-AAO136#002'),
    ...
    email_elements = [
        ('EmailAddress', 'info@bernstein.eu', '0173-1#02-AAO198#002'),
    ...
    # Create SMC Markings
    markings_elements = [
        ('MarkingName', 'Bernstein', get_iri_from_eclass('MarkingName')),
    ...
    temp_marking_file_path = Path(os.path.join(current_dir, 'logo', 'ManufacturerLogoBernstein.png'))
    ...
    marking_file = ent_instance.create_File(
        ...
        aasx_file_path='/aasx/Logo/ManufacturerLogoBernstein.png',
...
def create_general_information_submodel(obj_store, file_store):
    ...
    properties = [
        ('ManufacturerName', 'Bernstein AG', '0173-1#02-AAO677#002'),    
    ...
    # Use a temporary file path or replace with an existing file path
    temp_logo_file_path = Path(os.path.join(current_dir, 'logo', 'ManufacturerLogoBernstein.png'))
...
if __name__ == '__main__':
    ...
    output_filename_aasx = output_dir / 'Template_bernstein.aasx'
