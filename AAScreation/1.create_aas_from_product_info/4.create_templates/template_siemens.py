...
def create_nameplate_submodel(obj_store, file_store):
    ...
    address_elements = [
        ('Department', 'Corporate Headquarters', '0173-1#02-AAO127#003'),
        ('Street', 'Werner-von-Siemens-Str. 1', '0173-1#02-AAO128#002'),
        ('Zipcode', ' 80333', '0173-1#02-AAO129#002'),
        ('CityTown', 'Munich', '0173-1#02-AAO132#002'),
        ('StateCounty', 'Bayern', '0173-1#02-AAO133#002'),
        ('NationalCode', 'DE', '0173-1#02-AAO134#002'),
        ('AddressRemarks', 'Headquarters', '0173-1#02-AAO202#003'),
        ('AddressOfAdditionalLink', 'https://www.siemens.com/', '0173-1#02-AAQ326#002')
    ]

    phone_elements = [
        ('TelephoneNumber', ' +49 (89) 3803 5491', '0173-1#02-AAO136#002'),
        ('TypeOfTelephone', 'Office', '0173-1#02-AAO137#003')
    ]

    fax_elements = [
        ('FaxNumber',' +49 (69) 797 6664', '0173-1#02-AAO195#002'),
        ('TypeOfFaxNumber', 'Office', '0173-1#02-AAO196#003')
    ]

    email_elements = [
        ('EmailAddress', 'contact@siemens.com', '0173-1#02-AAO198#002'),
    ...
    markings_elements = [
        ('MarkingName', 'Siemens', get_iri_from_eclass('MarkingName')),
        ('MarkingAdditionalText', None, get_iri_from_eclass('MarkingAdditionalText'))
    ]
    temp_marking_file_path = Path(os.path.join(current_dir, 'logo', 'ManufacturerLogoSiemens.png'))
    ...
    marking_file = ent_instance.create_File(
        ...
        aasx_file_path='/aasx/Logo/ManufacturerLogoSiemens.png',
...
def create_general_information_submodel(obj_store, file_store):
    ...
    properties = [
        ('ManufacturerName', 'Siemens AG', '0173-1#02-AAO677#002'),
    ...
    # Logo & ProductImage
    temp_logo_file_path = Path(os.path.join(current_dir, 'logo', 'ManufacturerLogoSiemens.png'))
...
if __name__ == '__main__':
    ...
    output_filename_aasx = output_dir / 'Template_siemens.aasx'
