...
def create_nameplate_submodel(obj_store, file_store):
    ...
    address_elements = [
        ...
        ('Street', 'Ruiter Straße 82', '0173-1#02-AAO128#002'),
        ('Zipcode', '73734', '0173-1#02-AAO129#002'),


        ('CityTown', 'Esslingen', '0173-1#02-AAO132#002'),
        ('StateCounty', 'Baden Wuerttemberg', '0173-1#02-AAO133#002'),
        ('NationalCode', 'DE', '0173-1#02-AAO134#002'),

        ('AddressRemarks', 'Main Office', '0173-1#02-AAO202#003'),
        ('AddressOfAdditionalLink', 'https://www.festo.com/', '0173-1#02-AAQ326#002')
    ]

    phone_elements = [
        ('TelephoneNumber', '+49-711-347-0', '0173-1#02-AAO136#002'),
        ('TypeOfTelephone', 'Office', '0173-1#02-AAO137#003')
    ]

    fax_elements = [
        ('FaxNumber', '+49-711-347-2628', '0173-1#02-AAO195#002'),
        ('TypeOfFaxNumber', 'Office', '0173-1#02-AAO196#003')
    ]

    email_elements = [
        ('EmailAddress', 'info@festo.com', '0173-1#02-AAO198#002'),
    ...
    # Create SMC Markings
    markings_elements = [
        ('MarkingName', 'Festo', get_iri_from_eclass('MarkingName')),
    ...
    temp_marking_file_path = Path(os.path.join(current_dir, 'logo', 'ManufacturerLogoFesto.png'))
    ...
    marking_file = ent_instance.create_File(
        ...
        aasx_file_path='/aasx/Logo/ManufacturerLogoFesto.png',
...
def create_general_information_submodel(obj_store, file_store):
    ...
    properties = [
        ('ManufacturerName', 'Festo SE & Co. KG', '0173-1#02-AAO677#002'),    
    ...
    # Use a temporary file path or replace with an existing file path
    temp_logo_file_path = Path(os.path.join(current_dir, 'logo', 'ManufacturerLogoFesto.png'))
    ...
    image_file = ent_instance.create_File(
        ...
        aasx_file_path='/aasx/ProductImage/ProductImage.jpg',
...
if __name__ == '__main__':
    ...
    output_filename_aasx = output_dir / 'Template_festo.aasx'
